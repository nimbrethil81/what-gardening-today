...
> you have just cloned. Anything listed there has already been considered and deliberately
> dismissed — do not raise it again. If you believe a dismissal has genuinely gone stale,
> say so in one sentence with what changed, and do not re-argue it beyond that. The ledger
> lives in the repo rather than in the project precisely so that this rule cannot fail
> quietly: if you could clone, you can read it.
>
